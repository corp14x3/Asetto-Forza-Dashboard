    ...
    try:
        with mmap.mmap(0, BUFFER_SIZE_PHYSICS, AC_PHYSICS_FILE) as physics_mmap:
            ...
            while True:
                ...
                print(f"Speed: {physics.speedKmh:6.2f} km/h", end='\r')
                
                time.sleep(0.05)
                
    except FileNotFoundError:
        print(f"Error: '{AC_PHYSICS_FILE}' file not found. Assetto Corsa may not be running.")
    except Exception as e:
        print(f"\nAn unexpected error occurred: {e}")

if __name__ == "__main__":
    print_speed_to_console()